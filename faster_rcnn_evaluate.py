...
ground_truth_folder = r"C:\Users\Donna\Documents\m-vrt\cv-project\bdd100k\faster_rcnn\annotations"
predictions_folder = r"C:\Users\Donna\Documents\m-vrt\cv-project\bdd100k\faster_rcnn\predictions"
output_file = r"C:\Users\Donna\Documents\m-vrt\cv-project\bdd100k\faster_rcnn\faster_rcnn_evaluation_results.txt"
...
def load_boxes(txt_file, is_prediction=False):
    """Load bounding boxes from Faster R-CNN predictions or ground truth annotations."""
    boxes = []
